...
/// `target_size_in_bytes_ptr` points to a valid C string. A C string is used for the target size to
/// avoid issues with different platforms using an inconsistent amount of bits for integer types.
