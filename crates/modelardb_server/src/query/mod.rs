...
impl TableProvider for ModelTable {
    ...
    /// [`TableProvider::do_put()`] should be used instead of this method as it is more efficient.
    /// Returns a [`DataFusionError::Plan`] if the necessary metadata cannot be retrieved from the
    /// metadata database.
