...
impl CompressedDataManager {
    ...
    /// return [`crate::error::ModelarDbServerError`].
    ...
    /// otherwise return [`crate::error::ModelarDbServerError`].
    ...
    /// [`crate::error::ModelarDbServerError`] if the data cannot be flushed.
    ...
    /// successfully return [`Ok`], otherwise return [`crate::error::ModelarDbServerError`].
