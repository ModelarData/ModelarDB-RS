...
impl DataTransfer {
    ...
    /// `local_data_folder_path` could not be read, return [`crate::errors::ModelarDbServerError`].
    ...
    /// successfully, otherwise [`crate::errors::ModelarDbServerError`]. Note that if the function
    ...
    /// files were transferred successfully, otherwise [`crate::errors::ModelarDbServerError`].
