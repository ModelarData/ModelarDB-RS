...
| MODELARDBD_SEGMENT_SIZE_THRESHOLD_IN_BYTES       | 64 MB       | The maximum approximate size in bytes of a single WAL segment file before closing it and starting a new one.                                                                                                                                                                                             |
