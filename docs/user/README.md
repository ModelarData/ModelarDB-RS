...
| `--ingested-reserved-memory-in-bytes`     | `MODELARDBD_INGESTED_RESERVED_MEMORY_IN_BYTES`     | 512 MB      | ✓             | The amount of memory to reserve for storing ingested multivariate time series.                                                 |
